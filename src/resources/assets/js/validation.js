...
$(function () {
    ...
    var messages = {
	'mandatory' : 'Unique code is required.',
	...
	'firstname' : 'This field is required & length should be less than 50.',
    'city' : 'This field`s length should be less than 50.',
    ...
    jQuery.validator.addMethod("email", function (value, element) {
        if ($.trim(value) == "") {
            return true;
        } else if ( $.trim(value) != "" && !/^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/.test(value)) {
            return false;
        } else {
            return true;
        }
    ...
    jQuery.validator.addMethod("addressLine1", function (value, element) {
        if ($.trim(value) == ""  || $.trim(value).length > 50) {
            return false;
        } else {
            return true;
        }
    ...
    //Add New Method for - optional  + Maximum Length 64
